...
rem saxon %1 composer.xsl > comp-query.xsl
java -Xmx1000M -jar saxon8.jar -t %1 composer.xsl > comp-query.xsl
echo -Step2- Computing queries ----------------------------------------
java -Xmx1000M -jar saxon8.jar -t comp-driver.xml comp-query.xsl > temp\comp-res.xml
rem saxon comp-driver.xml comp-query.xsl > temp\comp-res.xml
